...
import { ArrowRight, CheckCircle2, Eye, EyeOff, KeyRound, Mail, ShieldCheck, UserRound, UsersRound } from 'lucide-react'
...
const Login = () => {
  ...
  const showConfirmPasswordField = isRegister || (isForgot && resetStep === 'reset')
  ...
  return (
    <main className='relative min-h-screen overflow-hidden bg-slate-950 text-white'>
      ...
      <div className='relative z-10 grid min-h-screen lg:grid-cols-[1.08fr_0.92fr]'>
        <section className='flex flex-col justify-center px-6 py-8 sm:px-10 lg:px-16 xl:px-24'>
